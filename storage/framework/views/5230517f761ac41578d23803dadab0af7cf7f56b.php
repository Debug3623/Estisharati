            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo e(route('dashboard.categories.update', $category->id)); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label><?php echo app('translator')->get('site.category'); ?></label>
                                ...
                                <select id="parent_id" name="parent_id" data-live-search="true" class="form-control" >
                                    ...
                                    <option value="<?php echo e($key); ?>" <?php if($category->parent_id==$key): ?> selected  <?php endif; ?>>
                                        <?php echo e($cat); ?>
                        ...
                        <?php endif; ?>
                                <input type="text" name="<?php echo e($locale); ?>[name]" class="form-control" value="<?php echo e($category->translate($locale)->name); ?>">
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/resources/views/dashboard/categories/edit.blade.php ENDPATH**/ ?>