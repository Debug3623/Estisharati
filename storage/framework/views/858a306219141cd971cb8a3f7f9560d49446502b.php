        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px"><?php echo app('translator')->get('site.faqs'); ?> (<small><?php echo e($faqs->total()); ?></small>)</h3>

                    <form action="<?php echo e(route('dashboard.faqs.create')); ?>" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo app('translator')->get('site.search'); ?></button>
                                    ...
                                    <a href="<?php echo e(route('dashboard.faqs.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo app('translator')->get('site.add'); ?></a>
                            ...
                            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                                ...
                                                <a href="<?php echo e(route('dashboard.faqs.edit', $faq->id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> <?php echo app('translator')->get('site.edit'); ?></a>
                                                
                                             
                                                    <form action="<?php echo e(route('dashboard.faqs.destroy', $faq->id)); ?>" method="post" style="display: inline-block">
                                                 ...
                                                 <form action="<?php echo e(route('dashboard.faqs.block', $faq->id)); ?>" method="post" style="display: inline-block">
                                                        <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/Modules/Faqs/Resources/views/faq/index.blade.php ENDPATH**/ ?>