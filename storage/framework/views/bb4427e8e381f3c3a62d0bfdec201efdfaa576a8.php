        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo e(route('dashboard.coupons.update',$coupon->id)); ?>" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-6">                           
                                ...
                                <input type="text" name="title_en" class="form-control" value=" <?php echo e($coupon->title_en); ?>"> 
                        </div>
                        <div class="form-group col-md-6">                           
                                <label><?php echo app('translator')->get('site.ar.title'); ?></label>
                                <input type="text" name="title_ar" class="form-control" value=" <?php echo e($coupon->title_ar); ?>"> 
                        </div>
                        <div class="form-group col-md-6">                           
                                <label><?php echo app('translator')->get('site.en.description'); ?></label>
                                <textarea name="description_en" class="form-control"><?php echo e($coupon->description_en); ?> </textarea> 
                        </div>
                        <div class="form-group  col-md-6">                           
                                <label><?php echo app('translator')->get('site.ar.description'); ?></label>
                                <textarea name="description_ar" class="form-control"><?php echo e($coupon->description_ar); ?> </textarea> 
                        </div>
                        <div class="form-group col-md-6">                           
                                <label><?php echo app('translator')->get('site.code'); ?></label>

                                <div class="input-group col-md-12">
                                    <input type="text" name="code" id="code" class="form-control" value=" <?php echo e($coupon->code); ?>"> 
                        ...
                        <div class="form-group col-md-6">
                                ...
                                <input type="text" name="discount_rate" class="form-control" value="<?php echo e($coupon->discount_rate); ?>">
                        </div>
                        <div class="form-group col-md-6">
                           
                                <label><?php echo app('translator')->get('site.count'); ?></label>
                       
                                <input type="text" name="count" class="form-control" value="<?php echo e($coupon->count); ?>">
                        </div>
                        <div class="form-group col-md-6">
                               ...
                               <div class="input-group date">
                                ...
                                <input type="text" autocomplete="off" name="start_at" class="form-control pull-right datepicker"  value="<?php echo e(date('d-m-Y',strtotime($coupon->start_at))); ?>" required>
                                </div>
                               </div>
                        <div class="form-group col-md-6">
                                ...
                                <input type="text" autocomplete="off" name="valid_to" class="form-control pull-right datepicker" value="<?php echo e(date('d-m-Y',strtotime($coupon->valid_to))); ?>" required>
                                </div>
                               </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/Modules/Coupons/Resources/views/coupon/edit.blade.php ENDPATH**/ ?>