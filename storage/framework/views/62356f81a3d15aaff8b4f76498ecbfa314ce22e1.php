        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    <h3 class="box-title"><?php echo app('translator')->get('site.purchased_packages'); ?></h3>
...
<script type="text/javascript">
    ...
    $('#search-form').on('submit', function(e) {
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('dashboard.reports.purchased_packages')); ?>",
            data: function (d) {
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/Modules/Reports/Resources/views/report/purchasedpackages.blade.php ENDPATH**/ ?>