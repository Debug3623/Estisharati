    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(route('dashboard.countries.index')); ?>"> <?php echo app('translator')->get('site.countries'); ?></a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo e(route('dashboard.countries.update', $country->id)); ?>" method="post">
                        ...
                        <?php endif; ?>
                                <input type="text" name="<?php echo e($locale); ?>[name]" class="form-control" value="<?php echo e((isset($country->translate($locale)->name)?$country->translate($locale)->name : '')); ?>" >
                            </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/Modules/Geography/Resources/views/country/edit.blade.php ENDPATH**/ ?>