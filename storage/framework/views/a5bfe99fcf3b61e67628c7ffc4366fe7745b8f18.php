    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body row">
                ...
                <form id="courseform" action="<?php echo e(route('dashboard.contactus.sendreply')); ?>" method="post">
                   ...
                   <div class="col-md-12">
                           ...
                           <input type="hidden" name="reply_to" class="form-control" value="<?php echo e($message->email); ?>">                                                   
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/resources/views/dashboard/contactus/reply.blade.php ENDPATH**/ ?>