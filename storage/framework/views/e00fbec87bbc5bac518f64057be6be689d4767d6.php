        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px"><?php echo app('translator')->get('site.countries'); ?> (<small><?php echo e($countries->total()); ?></small>)</h3>

                    <form action="<?php echo e(route('dashboard.countries.index')); ?>" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if(auth()->user()->hasPermission('create_geographies')): ?>
                                    <a href="<?php echo e(route('dashboard.countries.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo app('translator')->get('site.add'); ?></a>
                                    ...
                                    <td>
                                        ...
                                        <!-- <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"> -->
                                                ...
                                                <a href="<?php echo e(route('dashboard.countries.edit', $country->id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> <?php echo app('translator')->get('site.edit'); ?></a>
                                                
                                                <?php endif; ?>
                                                <!-- <br> -->
                                                <?php if(auth()->user()->hasPermission('delete_geographies')): ?>
                                                    <form action="<?php echo e(route('dashboard.countries.destroy', $country->id)); ?>" method="post" style="display: inline-block">
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/Modules/Geography/Resources/views/country/index.blade.php ENDPATH**/ ?>