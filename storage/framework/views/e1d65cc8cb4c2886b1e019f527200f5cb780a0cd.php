        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px"><?php echo app('translator')->get('site.coupons'); ?> (<small><?php echo e($coupons->total()); ?></small>)</h3>

                    <form action="<?php echo e(route('dashboard.coupons.create')); ?>" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo app('translator')->get('site.search'); ?></button>
                                    ...
                                    <a href="<?php echo e(route('dashboard.coupons.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo app('translator')->get('site.add'); ?></a>
                    ...
                    <?php if($coupons->count() > 0): ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('site.code'); ?></th>
                                ...
                                <th><?php echo app('translator')->get('site.count'); ?></th>
                                <th><?php echo app('translator')->get('site.usage'); ?></th>
                            ...
                            <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($coupon->title_en); ?> </td>
                                    <td><?php echo e($coupon->title_ar); ?></td>
                                    <td><?php echo e($coupon->code); ?></td>
                                    <td><?php echo e(date('d-m-Y',strtotime($coupon->start_at))); ?></td>
                                    <td><?php echo e(date('d-m-Y',strtotime($coupon->valid_to))); ?> </td>
                                    <td><?php echo e($coupon->discount_rate); ?></td>
                                    <td><?php echo e($coupon->count); ?></td>
                                    <td><?php echo e($coupon->usage); ?></td>
                                    ...
                                    <td>
                                                ...
                                                <a href="<?php echo e(route('dashboard.coupons.edit', $coupon->id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> <?php echo app('translator')->get('site.edit'); ?></a>
                                                
                                             
                                                    <form action="<?php echo e(route('dashboard.coupons.destroy', $coupon->id)); ?>" method="post" style="display: inline-block">
                                                 ...
                                                 <form action="<?php echo e(route('dashboard.coupons.block', $coupon->id)); ?>" method="post" style="display: inline-block">
                                                        <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/Modules/Coupons/Resources/views/coupon/index.blade.php ENDPATH**/ ?>