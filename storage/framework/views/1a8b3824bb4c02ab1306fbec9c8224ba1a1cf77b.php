        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo e(route('dashboard.roles.store')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="display_name" class="form-control" value="<?php echo e(old('display_name')); ?>">
                        </div>
                        <div class="form-group">
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group <?php echo e($index == 0 ? 'active' : ''); ?>" id="<?php echo e($model); ?>">
                                            ...
                                            <?php $__currentLoopData = $maps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $map): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label><input type="checkbox" name="permissions[]" value="<?php echo e($map . '_' . $model); ?>"> <?php echo app('translator')->get('site.' . $map); ?></label>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superservers/public_html/estisharati/resources/views/dashboard/roles/create.blade.php ENDPATH**/ ?>